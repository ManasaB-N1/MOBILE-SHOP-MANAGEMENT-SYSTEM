...
insert  into `products`(`p_id`,`prod_name`,`item_price`,`item_image`,`item_desc`,`c_id`,`min_stock`,`total_stock`,`cre_date`) values (1,'Samsung Galaxy','15000','pro1573883798.jpg','asdf','sumsung','3','91','2019-11-16 06:53:39'),(2,'redmi','10000','pro1573883852.jpg','lorem epsum','redmi','3','91','2019-11-16 06:57:32');
...
insert  into `shopkeeper`(`sid`,`f_name`,`l_name`,`s_mail`,`s_pass`,`s_pho`,`s_address`,`s_active`) values (1,'Aishwarya','S','4stripe@gmail.com','Asdf1234','8745369120','#267,, Saraswathipuram','1'),(2,'Anoop','p','new@gmail.com','Asdf1234','5435435454','#267,, Saraswathipuram','1');
