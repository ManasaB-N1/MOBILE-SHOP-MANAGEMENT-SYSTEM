...
<body>
	...
	<div class="footer">
		...
		<div class="footer-copy">
			...
			<div class="container">
				<p>© 2019 Mobile Shop Managament. All rights reserved</p>
			</div>
		</div>
	...
	if (isset($_POST['submit'])) {
		...
		$query = mysqli_query($connection, "SELECT * from admin_login WHERE username='$email' and pass='$password'");
		...
		if ($exists > 0) {
			...
			print '<script>window.location.assign("Admin/admin_dashboard.php");</script>';
		} else {
